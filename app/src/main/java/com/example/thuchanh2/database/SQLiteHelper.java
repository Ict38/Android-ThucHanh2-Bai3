...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public long addBook(Book book){
        ...
        contentValues.put("name", book.getTen());
        contentValues.put("author", book.getTacGia());
        contentValues.put("publishDate", book.getNgayXB());
        contentValues.put("publisher", book.getNhaXB());
        contentValues.put("price", Float.parseFloat(book.getGia()));
